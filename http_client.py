...
def create_cmd_parser():
    ...
    parser.add_argument('-t', '--type', default='GET',
                        dest="req_type",
                        help='Possible: GET, POST, HEAD, OPTIONS,'
                             ' CONNECT, TRACE, DELETE, PUT, TRACE')
    parser.add_argument('-T', '--timeout', default='0',
                        dest="timeout",
                        help='to set timeout')
    parser.add_argument('-d', '--body', default='',
                        dest="body",
    ...
    parser.add_argument('-H', '--headers', default=None, nargs='+',
                        dest="custom_headers",
                        help='to add custom headers or'
...
if __name__ == '__main__':
    ...
    try:
        request = req.Request(args.link, args.custom_headers,
